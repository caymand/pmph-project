...
| Command                                           | TFLOPS  |
|---------------------------------------------------|---------|
| ./compile.sh 4 4 1 1 1 2 2 2 -DNOUNROLL && ./main | 26266.4 |

## A100
| Command                                       | TFLOPS |
|-----------------------------------------------|--------|
| ./compile.sh 4 4 1 2 2 2 && ./main            | 133995 |
| ./compile.sh 4 4 2 2 2 2 -DNOUNROLL && ./main | 140373 |
| ./compile.sh 2 4 2 4 2 2 -DNOUNROLL && ./main | 145361 |
| ./compile.sh 4 2 2 2 4 2 -DNOUNROLL && ./main | 149569 |
| ./compile.sh 4 2 1 1 1 4 4 4 && ./main        | 145392 |
